...
function addRecipes(e) {
    ...
    if (e.target.classList.contains('add-recipe')) {
        ...
        for (let i = 1;i <= 5; i++) {
            newPromises.push(fetch('https://www.themealdb.com/api/json/v1/1/random.php').then(response => response.json()));
        };
